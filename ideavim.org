...
set NERDTree " help -> https://github.com/JetBrains/ideavim/wiki/NERDTree-support
...
* Ideas / Todos
** [#B] U -> C+A+Z -> Git revert
** [#B] Open Magit with <leader>gg
Problem is that the window is not focused
#+begin_src
